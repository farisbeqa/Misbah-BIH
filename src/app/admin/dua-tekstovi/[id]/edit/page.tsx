...
export default function EditDuaTextPage() {
  ...
  if (loading) return <div className="min-h-screen bg-gray-50 flex items-center justify-center"><Loader2 className="animate-spin text-brand" size={28} /></div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-2xl font-black text-gray-900 mb-6">Uredi tekst dove</h1>
